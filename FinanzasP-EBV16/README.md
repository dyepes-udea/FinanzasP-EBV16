...
- **Tarjetas resumen** — total ingresos, total gastos y balance actual
- **Listado unificado** — ingresos y gastos en una sola vista, ordenados por fecha
- **Agregar transacción** — modal con formulario (tipo, descripción, categoría, monto, fecha)
- **Eliminar transacción** — botón ✕ en cada fila
- **Búsqueda** — filtrado en tiempo real por descripción o categoría
- **Filtro por tipo** — ver todas, solo ingresos o solo gastos
